...
EOF;
	...
	case 7:
		...
		{
			$sql[]="insert into {$proverbtable_prefix}setting(variable,content) values('site_title','".addslashes(trim(strip_tags($_POST['site_title'])))."'),('site_url','".addslashes(trim(strip_tags($_POST['site_url'])))."'),('site_imgurl','".$_POST['img_url']."'),('site_videourl','".$_POST['video_url']."'),('site_charset','utf-8'),('adminpath','admin');";
