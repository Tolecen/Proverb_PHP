...
<div class="header">
    <div class="col-auto">
        ...
        <ul class="nav white" id="top_menu">
			 <li id="man_nav_1" onclick="list_sub_nav('man_nav_1','管理首页')"  style="outline:none;"  class="on top_menu"><A HREF="#">管理首页</A></li><li id="man_nav_3" onclick="list_sub_nav('man_nav_3','会员管理')"  style="outline:none;"  class="top_menu"><A HREF="#">会员管理</A></li><li id="man_nav_4"  onclick="list_sub_nav('man_nav_4','数据信息')"  style="outline:none;"  class="top_menu"><A HREF="#">数据信息</A></li>
        </ul>
    </div>
</div>
<SCRIPT LANGUAGE="JavaScript">
